 ...
 * numărate din `MATERII`, sesiunile anterioare din aceeași listă. Regula
 * proiectului e că nicio cifră afișată nu se scrie de mână, iar o pagină de
 * prezentare e exact locul unde tentația de a inventa „1000+ grile" sau „5000 de
 * elevi" e cea mai mare. Nu apare niciuna: dimensiunea băncii nu e încă un
 * argument, deci nu e folosită ca argument.
 *
...
const sesiuni = MATERII.ant.list.length;
...
export function Cifre() {
  ...
  const cifre: Cifra[] = [
    ...
    { valoare: sesiuni, eticheta: 'Sesiuni anterioare', nota: 'Subiecte din 2022 încoace' },
