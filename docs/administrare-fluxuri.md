...
- **Previzualizarea bibliotecii** citește o grilă completă numai când administratorul apasă „Previzualizează”, prin citirea administrativă existentă. Arată enunțul întreg, afirmațiile, opțiunile, răspunsul corect, explicațiile și referința; nu modifică formularul nesalvat. Închiderea demontează citirea, răspunsurile întârziate sunt ignorate, iar redeschiderea citește din nou. Cardul pune textul și formatul în față; codul intern rămâne în detaliile secundare. Ordinea și paginarea existente nu se schimbă.
- **Acoperirea programei** oferă „Vezi grilele”, „Adaugă aici” și „Importă aici” pentru fiecare capitol. Un formular nou preselectează capitolul; o grilă nesalvată nu este înlocuită. Importul gol preselectează capitolul și formatul tabelar. Un lot existent cere aplicarea explicită a noului capitol; JSON păstrează încadrarea fiecărui rând. Nicio comandă de scurtătură nu publică sau salvează conținut.
...
- **Corectarea tabelului** deschide celulele originale în panouri pe rând, câte zece rânduri pe pagină. Se pot vedea numai rândurile cu erori. Înainte de editare se fixează codurile interne, care nu sunt editabile în panou; textul citat, taburile și rândurile noi sunt serializate fără pierderi. Orice corectură anulează confirmarea verificării. Antetele greșite se repară în textul lipit; editorul apare numai după citirea structurii tabelului.
- **Enunțurile repetate** sunt semnalate în interiorul lotului TSV, ignorând majusculele, diacriticele și spațiile repetate. Nu se compară cu biblioteca, nu se deduc duplicate semantice și nu se elimină nimic automat: două întrebări pot avea același enunț, dar răspunsuri diferite.
